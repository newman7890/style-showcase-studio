  ...
  public: {
    Tables: {
      ...
      hub_inventory: {
        ...
        Relationships: [
          {
            foreignKeyName: "hub_inventory_hub_id_fkey"
            columns: ["hub_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "hub_inventory_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      order_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "order_items_origin_hub_id_fkey"
      ...
      seller_dropoff_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "seller_dropoff_items_dropoff_id_fkey"
            columns: ["dropoff_id"]
            isOneToOne: false
            referencedRelation: "seller_dropoffs"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "seller_dropoff_items_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      seller_dropoffs: {
        ...
        Relationships: [
          {
            foreignKeyName: "seller_dropoffs_hub_id_fkey"
            columns: ["hub_id"]
            isOneToOne: false
            referencedRelation: "hubs"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      consume_rider_access_code: { Args: { _code: string }; Returns: boolean }
